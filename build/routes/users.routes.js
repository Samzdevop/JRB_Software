...
exports.usersRouter.get('/', errorHandler_1.authenticateJWT, users_controllers_1.getAllUsers);
exports.usersRouter.get('/:userId', errorHandler_1.authenticateJWT, users_controllers_1.getUserById);
exports.usersRouter.delete('/:userId', errorHandler_1.authenticateJWT, 
